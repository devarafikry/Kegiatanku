...
public class Geofencing implements ResultCallback {
    ...
    public void addPlaceToGeofenceList(final ActivitySchedule activity, GoogleApiClient client){
        if(activity != null){
            Places.GeoDataApi.getPlaceById(client, activity.getPlace_id())
                    .setResultCallback(new ResultCallback<PlaceBuffer>() {
                        ...
                        public void onResult(PlaceBuffer places) {
                            if (places.getStatus().isSuccess() && places.getCount() > 0) {
                                ...
                                double placeLat = place.getLatLng().latitude;
                                double placeLng = place.getLatLng().longitude;
                                Long geofenceDuration = activity.getTime_end()-activity.getTime_start();
                                Geofence geofence = new Geofence.Builder()
                                        .setRequestId(activity.getKey())
...
//                                        .build();
                                ...
                                Log.i("ManageActivityFragment", "Place found: " + place.getName());
                            } else {
...
//        }
    ...
    public void onResult(@NonNull Result result) {
        ...
        Log.e(TAG, "Bisa kah?"+result.toString());
    }
}
